...
import (
    "picoclaw/agent/pkg/bus"
    "picoclaw/agent/pkg/channels"     // 引用父包
    "picoclaw/agent/pkg/config"
    "picoclaw/agent/pkg/identity"      // 新增
    "picoclaw/agent/pkg/media"          // 新增（如需媒体）
)
```
...
import (
    _ "picoclaw/agent/pkg/channels/telegram"   // 触发 init() 注册
    _ "picoclaw/agent/pkg/channels/discord"
    _ "picoclaw/agent/pkg/channels/your_new_channel"  // 新增
)
```
