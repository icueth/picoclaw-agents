...
import (
    "picoclaw/agent/pkg/bus"
    "picoclaw/agent/pkg/channels"     // Reference parent package
    "picoclaw/agent/pkg/config"
    "picoclaw/agent/pkg/identity"      // New
    "picoclaw/agent/pkg/media"          // New (if media support needed)
)
```
...
import (
    _ "picoclaw/agent/pkg/channels/telegram"   // Triggers init() registration
    _ "picoclaw/agent/pkg/channels/discord"
    _ "picoclaw/agent/pkg/channels/your_new_channel"  // New addition
)
```
...
// cmd/picoclaw/internal/gateway/helpers.go
import (
    _ "picoclaw/agent/pkg/channels/matrix"
)
```
