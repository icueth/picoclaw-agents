...
// Note: memory/MEMORY.md is NOT part of the cached system prompt — it is loaded
// dynamically per-request in BuildMessages (capability-aware), so it is tested
// separately in TestMemoryDynamicLoading.
...
// Note: memory/MEMORY.md is excluded — it is loaded dynamically in BuildMessages.
