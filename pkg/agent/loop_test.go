...
func newTestAgentLoop(
	...
	jobManager := memory.NewJobManager(nil, nil)
	al = NewAgentLoop(cfg, msgBus, provider, jobManager, nil)
...
func TestRecordLastChannel(t *testing.T) {
	...
	al2 := NewAgentLoop(cfg, msgBus, provider, nil, nil)
...
func TestNewAgentLoop_StateInitialized(t *testing.T) {
	...
	msgBus := bus.NewMessageBus()
	provider := &mockProvider{}
	al := NewAgentLoop(cfg, msgBus, provider, nil, nil)
...
func TestToolContext_Updates(t *testing.T) {
	...
	_ = NewAgentLoop(cfg, msgBus, provider, nil, nil)
...
func TestTargetReasoningChannelID_AllChannels(t *testing.T) {
	...
	al := NewAgentLoop(cfg, bus.NewMessageBus(), &mockProvider{}, nil, nil)
...
func TestHandleReasoning(t *testing.T) {
	newLoop := func(t *testing.T) (*AgentLoop, *bus.MessageBus) {
		...
		msgBus := bus.NewMessageBus()
		return NewAgentLoop(cfg, msgBus, &mockProvider{}, nil, nil), msgBus
	}
